      ...
      <div class="hero-content">
        ...
        <div class="hero-text">
          ...
          <p class="hero-subtitle">
            Bantu anak membangun kebiasaan baik dengan mencatat jam bangun
            paginya hari ini.
          </p>
        </div>
      </div>
        ...
        <template v-if="!isTimeWindowValid && !todayData.saved">
          <div class="locked-state">
            ...
            <div class="locked-text">
              ...
              <p>
                Penginputan jurnal <strong>Bangun Pagi</strong> hanya bisa
                dilakukan antara pukul <strong>04:00 hingga 10:59 pagi</strong>.
                Hal ini untuk memastikan kedisiplinan dan keakuratan data.
              </p>
            </div>
          </div>
        </template>
          ...
          <div class="today-input-section" v-if="!todayData.saved">
            <div class="time-input-wrapper">
              <label class="time-label"
                >Jam berapa anak bangun hari ini? ({{ todayFormatted }})</label
              >
          ...
          <div class="today-success-section" v-else>
            <div class="success-badge" :class="getTimeStatus(todayData.time)">
              ...
              <div class="success-text">
                <strong>Tersimpan!</strong> Anda telah mengisi catatan hari ini
                pada pukul
...
onMounted(async () => {
  ...
  let { data: masterKebiasaan } = await supabase
    .from("kebiasaan")
    .select("id")
    .ilike("nama_kebiasaan", "%bangun%")
    .single();

  if (!masterKebiasaan) {
    const { data: newK } = await supabase
      .from("kebiasaan")
      .insert({ nama_kebiasaan: "Bangun Pagi" })
      .select("id")
      .single();
